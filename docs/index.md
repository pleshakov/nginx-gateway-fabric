...
For a list of supported Gateway API resources and features, see the [Gateway API Compatibility](gateway-api-compatibility.md) doc.
...
1. [Quick Start on a kind cluster](running-on-kind).
2. [Install](installation) NGINX Kubernetes Gateway.
3. [Build](building-the-image) an NGINX Kubernetes Gateway container image from source or use a pre-built image available on [GitHub Container Registry](https://github.com/nginxinc/nginx-kubernetes-gateway/pkgs/container/nginx-kubernetes-gateway).
